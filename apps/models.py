...
class Log_Project_Config(models.Model):
    ...
    user = models.CharField(max_length=50,verbose_name='操作用户',default=None)
    content = models.CharField(max_length=200,default=None,blank=True,null=True)
    version = models.CharField(max_length=100,default=None,blank=True,null=True)
    ...
    uuid = models.CharField(max_length=50,verbose_name='唯一id')
...
class Log_Project_Record(models.Model):
    ...
    status = models.CharField(max_length=10,default=None,blank=True,null=True)
    uuid = models.CharField(max_length=50,db_index=True,verbose_name='唯一id') 
    create_time = models.DateTimeField(auto_now_add=True,blank=True,null=True,verbose_name='执行时间')
    class Meta:
        default_permissions = ()
...
class Project_Number(models.Model):
    ...
    logpath = models.CharField(max_length=500,verbose_name='日志路径',default=None)
    server =  models.SmallIntegerField(verbose_name='服务器IP',default=None)
