...
urlpatterns = [
            ...
            url(r'^sql/custom/$', mysql_api.DB_CUSTOM_SQL.as_view()),
            url(r'^sql/custom/(?P<id>[0-9]+)/$', mysql_api.sql_custom_detail), 
            ...
            url(r'^logs/sql/$', mysql_api.DatabaseExecuteHistroy.as_view()),   
            url(r'^logs/sql/(?P<id>[0-9]+)/$', mysql_api.DatabaseExecuteHistroyDetail.as_view()), 
