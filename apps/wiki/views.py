...
@login_required()
@permission_required('wiki.wiki_can_add_wiki_post',login_url='/403/')
...
@login_required()
@permission_required('wiki.wiki_can_edit_wiki_post',login_url='/403/')
...
@login_required()
@permission_required('wiki.wiki_can_read_wiki_post',login_url='/403/')
