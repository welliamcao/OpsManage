...
#             url(r'^playbook/$', deploy_api.playbook_list),  
#             url(r'^playbook/(?P<id>[0-9]+)/$', deploy_api.playbook_detail),
            ...
            url(r'^apps/list/$', apps_api.project_list),   
            url(r'^apps/list/(?P<id>[0-9]+)/$', apps_api.project_detail), 
            url(r'^apps/logs/$', apps_api.AppsLogPaginator.as_view()),  
            url(r'^apps/log/(?P<id>.+)/$', apps_api.project_log_detail), 
            url(r'^apps/logs/detail/(?P<id>.+)/$', apps_api.AppsLogRecord.as_view()),  
            url(r'^apps/count/$', apps_api.AppsCounts.as_view()), 
            url(r'^apps/roles/$', apps_api.apps_roles_list),    
            url(r'^apps/roles/(?P<id>[0-9]+)/$', apps_api.apps_roles_detail),                       
