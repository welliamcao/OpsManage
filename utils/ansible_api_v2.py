...
class ModelResultsCollectorToSave(CallbackBase):  
    ...
    def v2_runner_on_unreachable(self, result):  
        ...
        if self.logId:DeploySaveResult.Model.insert(self.logId, data)
...
class PlayBookResultsCollectorToSave(CallbackBase):  
    ...
    def v2_runner_on_ok(self, result, *args, **kwargs):  
        ...
        if result._task.loop and 'results' in result._result:
            ...
            if self.logId:DeploySaveResult.PlayBook.insert(self.logId, msg)    
...
class ANSRunner(object):  
    ...
    def run_model(self,host_list, module_name, module_args):
        ...
        try:
            ...
            if self.logId:DeploySaveResult.Model.insert(self.logId, err)              
        finally:  
            if tqm is not None:  
                tqm.cleanup()  
            if self.loader:
