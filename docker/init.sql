...
CREATE TABLE `django_admin_log` (
  ...
  KEY `django_admin_log_user_id_c564eba6_fk_opsmanage_user_id` (`user_id`),
  CONSTRAINT `django_admin_log_content_type_id_c4bce8eb_fk_django_co` FOREIGN KEY (`content_type_id`) REFERENCES `django_content_type` (`id`),
  CONSTRAINT `django_admin_log_user_id_c564eba6_fk_opsmanage_user_id` FOREIGN KEY (`user_id`) REFERENCES `opsmanage_user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `opsmanage_assets_department_tree`
--

DROP TABLE IF EXISTS `opsmanage_assets_department_tree`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `opsmanage_assets_department_tree` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `assets_id` int(11) NOT NULL,
  `structure_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `opsmanage_assets_departm_assets_id_structure_id_ff22b118_uniq` (`assets_id`,`structure_id`),
  KEY `opsmanage_assets_dep_structure_id_6d1b997c_fk_opsmanage` (`structure_id`),
  CONSTRAINT `opsmanage_assets_dep_assets_id_5fd4ac9f_fk_opsmanage` FOREIGN KEY (`assets_id`) REFERENCES `opsmanage_assets` (`id`),
  CONSTRAINT `opsmanage_assets_dep_structure_id_6d1b997c_fk_opsmanage` FOREIGN KEY (`structure_id`) REFERENCES `opsmanage_structure` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `opsmanage_order_system` (
  ...
  `order_audit_status` smallint(6) NOT NULL,
  `order_execute_status` smallint(6) NOT NULL,
...
--
-- Table structure for table `opsmanage_order_system_log`
--

DROP TABLE IF EXISTS `opsmanage_order_system_log`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `opsmanage_order_system_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `order` int(11) NOT NULL,
  `audit_status` smallint(6) NOT NULL,
  `execute_status` smallint(6) NOT NULL,
  `operator` smallint(6) NOT NULL,
  `operation_info` longtext,
...
--
-- Table structure for table `opsmanage_redis_detail`
--

DROP TABLE IF EXISTS `opsmanage_redis_detail`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `opsmanage_redis_detail` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `db_name` varchar(50) NOT NULL,
...
--
-- Table structure for table `opsmanage_redis_server_config`
--

DROP TABLE IF EXISTS `opsmanage_redis_server_config`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `opsmanage_redis_server_config` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `db_env` varchar(10) NOT NULL,
  `db_type` varchar(10) DEFAULT NULL,
  `db_business` int(11) NOT NULL,
...
--
-- Table structure for table `opsmanage_redis_user`
--

DROP TABLE IF EXISTS `opsmanage_redis_user`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `opsmanage_redis_user` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `db` smallint(6) NOT NULL,
  `user` smallint(6) NOT NULL,
  `is_write` smallint(6) NOT NULL,
...
--
-- Table structure for table `opsmanage_role`
--

DROP TABLE IF EXISTS `opsmanage_role`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `opsmanage_role` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `opsmanage_role_permissions`
--

DROP TABLE IF EXISTS `opsmanage_role_permissions`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `opsmanage_role_permissions` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `role_id` int(11) NOT NULL,
  `permission_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `opsmanage_role_permissions_role_id_permission_id_47d0684c_uniq` (`role_id`,`permission_id`),
...
--
-- Table structure for table `opsmanage_service_audit_order`
--

DROP TABLE IF EXISTS `opsmanage_service_audit_order`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `opsmanage_service_audit_order` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `order_content` longtext NOT NULL,
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `order_id` (`order_id`),
  CONSTRAINT `opsmanage_service_au_order_id_0873804c_fk_opsmanage` FOREIGN KEY (`order_id`) REFERENCES `opsmanage_order_system` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `opsmanage_sql_execute_history`
--

DROP TABLE IF EXISTS `opsmanage_sql_execute_history`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `opsmanage_sql_execute_history` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `exe_user` varchar(100) NOT NULL,
  `exe_sql` longtext NOT NULL,
  `exec_status` smallint(6) DEFAULT NULL,
  `exe_result` longtext,
  `exe_time` smallint(6) NOT NULL,
  `exe_effect_row` bigint(20) DEFAULT NULL,
...
--
-- Table structure for table `opsmanage_structure`
--

DROP TABLE IF EXISTS `opsmanage_structure`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `opsmanage_structure` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `text` varchar(60) NOT NULL,
  `desc` varchar(150) DEFAULT NULL,
  `type` varchar(20) NOT NULL,
  `manage` smallint(6) DEFAULT NULL,
  `mail_group` varchar(200) DEFAULT NULL,
  `wechat_webhook_url` longtext,
  `dingding_webhook_url` longtext,
  `lft` int(10) unsigned NOT NULL,
  `rght` int(10) unsigned NOT NULL,
  `tree_id` int(10) unsigned NOT NULL,
  `level` int(10) unsigned NOT NULL,
...
--
-- Table structure for table `opsmanage_user`
--

DROP TABLE IF EXISTS `opsmanage_user`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `opsmanage_user` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `opsmanage_user_department`
--

DROP TABLE IF EXISTS `opsmanage_user_department`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `opsmanage_user_department` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL,
  `structure_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `opsmanage_user_department_user_id_structure_id_8046d0a8_uniq` (`user_id`,`structure_id`),
...
--
-- Table structure for table `opsmanage_user_groups`
--

DROP TABLE IF EXISTS `opsmanage_user_groups`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `opsmanage_user_groups` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL,
  `group_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `opsmanage_user_groups_user_id_group_id_da89d5fe_uniq` (`user_id`,`group_id`),
  KEY `opsmanage_user_groups_group_id_0d368c86_fk_auth_group_id` (`group_id`),
  CONSTRAINT `opsmanage_user_groups_group_id_0d368c86_fk_auth_group_id` FOREIGN KEY (`group_id`) REFERENCES `auth_group` (`id`),
  CONSTRAINT `opsmanage_user_groups_user_id_754cc564_fk_opsmanage_user_id` FOREIGN KEY (`user_id`) REFERENCES `opsmanage_user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `opsmanage_user_roles`
--

DROP TABLE IF EXISTS `opsmanage_user_roles`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `opsmanage_user_roles` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL,
  `role_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `opsmanage_user_roles_user_id_role_id_e5daf796_uniq` (`user_id`,`role_id`),
...
--
-- Table structure for table `opsmanage_user_task`
--

DROP TABLE IF EXISTS `opsmanage_user_task`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `opsmanage_user_task` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `opsmanage_user_user_permissions`
--

DROP TABLE IF EXISTS `opsmanage_user_user_permissions`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `opsmanage_user_user_permissions` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL,
  `permission_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `opsmanage_user_user_perm_user_id_permission_id_1d1a0975_uniq` (`user_id`,`permission_id`),
  KEY `opsmanage_user_user__permission_id_4093f6e2_fk_auth_perm` (`permission_id`),
  CONSTRAINT `opsmanage_user_user__permission_id_4093f6e2_fk_auth_perm` FOREIGN KEY (`permission_id`) REFERENCES `auth_permission` (`id`),
  CONSTRAINT `opsmanage_user_user__user_id_b195b30d_fk_opsmanage` FOREIGN KEY (`user_id`) REFERENCES `opsmanage_user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `opsmanage_wiki_post` (
  ...
  KEY `opsmanage_wiki_post_author_id_d38d8ae4_fk_opsmanage_user_id` (`author_id`),
  KEY `opsmanage_wiki_post_category_id_c60956a6_fk_opsmanage` (`category_id`),
  CONSTRAINT `opsmanage_wiki_post_author_id_d38d8ae4_fk_opsmanage_user_id` FOREIGN KEY (`author_id`) REFERENCES `opsmanage_user` (`id`),
